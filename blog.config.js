...
const BLOG = {
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://ooo.0x0.ooo/2025/01/31/OGtnoS.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
